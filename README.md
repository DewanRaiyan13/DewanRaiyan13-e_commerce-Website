...
5. Click **Deploy**.
6. Once deployed, copy the backend URL (e.g., [https://doneshop-ecommerce-website.vercel.app/](https://doneshop-ecommerce-website.vercel.app/)).
...
5. Click **Deploy**.
6. Once the frontend is deployed, copy the frontend URL (e.g., [https://doneshop-ecommerce-website.vercel.app](https://doneshop-ecommerce-website.vercel.app)).

### 3. Final Integration
1. Go back to your **Backend Project** settings on Vercel.
2. In **Environment Variables**, add a new variable called `FRONTEND_URL`.
3. Set its value to your deployed frontend URL (e.g., [https://doneshop-ecommerce-website.vercel.app/](https://doneshop-ecommerce-website.vercel.app/)).
